const serverHost = "http://192.168.204.122:3000";
...
export const uploadAddress = `${serverHost}/api/upload/delivary/information`;

// all in one
export const getAllProducts = `${serverHost}/api/products`;
